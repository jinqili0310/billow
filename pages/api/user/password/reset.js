 ...
 * @LastEditTime: 2021-02-28 16:24:26
 * @FilePath: /billow-website/pages/api/user/password/reset.js
 */
  ...
  const msg = {
    ...
    html: `
      <div>
        ...
        <p>Please follow <a href="${process.env.WEB_URI}/forgetpassword/${token._id}">this link</a> to reset your password.</p>
      </div>
      `,
  };
  await sendMail(msg);
